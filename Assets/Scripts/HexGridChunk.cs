...
public class HexGridChunk : MonoBehaviour {
    ...
    void Triangulate(HexCell cell) {
        ...
        // for (int i = 0; i < 6; i++) {
        //     terrain.AddTriangle(center, center + HexMetrics.corners[i], center + HexMetrics.corners[(i + 1) % 6]);
    ...
    void TriangulateWithRiver(HexDirection direction, HexCell cell, Vector3 center, EdgeVertices e) {
        ...
        // After deciding where the left and right points are, determine the final center by averaging
    ...
    void TriangulateCornerTerracesCliff(
        ...
        float b = 1f / Mathf.Abs(rightCell.Elevation - beginCell.Elevation);
    ...
    void TriangulateCornerCliffTerraces(
        ...
        float b = 1f / Mathf.Abs(leftCell.Elevation - beginCell.Elevation);
    ...
    void TriangulateRiverQuad(Vector3 v1, Vector3 v2, Vector3 v3, Vector3 v4, float y1, float y2, float v,
        bool reversed) {
        v1.y = v2.y = y1;
        v3.y = v4.y = y2;
